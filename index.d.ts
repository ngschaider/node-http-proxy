...
declare namespace Server {
    ...
    interface ServerOptions {
        ...
        onProxyReqWs?: ProxyReqWsCallback;
        onProxyRes?: ProxyResCallback;
    }

    type StartCallback = (req: http.IncomingMessage, res: http.ServerResponse, target: ProxyTargetUrl) => Promise<void>|void;
    type EndCallback = (req: http.IncomingMessage, res: http.ServerResponse, proxyRes: http.IncomingMessage) => Promise<void>|void;
    type OpenCallback = (proxySocket: net.Socket) => Promise<void>|void;
    type CloseCallback = (proxyRes: http.IncomingMessage, proxySocket: net.Socket, proxyHead: any) => Promise<void>|void;
