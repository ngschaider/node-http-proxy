...
Check the [README.md](https://github.com/ngschaider/node-http-proxy/blob/master/README.md) for a more detailed explanation of the parameters.

## Proxying

Web proxying is done by calling the `.web()` method on a Proxy instance. You can check among some use cases in the [examples folder](https://github.com/ngschaider/node-http-proxy/tree/master/examples/http)
...
Websockets are proxied by the `.ws()` method. The [examples folder](https://github.com/ngschaider/node-http-proxy/tree/master/examples/websocket) again provides a lot of useful snippets!
...
The new API makes it really easy to implement code that behaves like the old Middleware API. You can check some examples [here](https://github.com/ngschaider/node-http-proxy/tree/master/examples/middleware)
